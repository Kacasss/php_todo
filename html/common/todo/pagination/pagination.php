<nav aria-label="Page navigation example">
    ...
    <li class="page-item <?= $now_page === 1 ? "disabled" : ""; ?>">
        <a class="page-link" href="./?page_num=<?= $now_page - 1; ?>" aria-label="Previous">
    ...
    <?php for ($i = 1; $i <= $max_page; $i++) { ?>
        <?php if ($i == $now_page) : ?>
            <li class="page-item active">
                <a class="page-link" href="./?page_num=<?= $i; ?>"><?= $now_page ?></a>
            </li>
        <?php else : ?>
            <li class="page-item">
    ...
    <li class="page-item <?= $now_page === $max_page ? "disabled" : ""; ?>">
        <a class="page-link" href="./?page_num=<?= $now_page + 1; ?>" aria-label="Next">
