<?php
    ...
    // 登録フォームからindex.phpに戻り、次に登録フォームに移る時、
    // 入力内容が未入力の状態にする
    if (isset($_SESSION["todo_item"])) {
        $_SESSION["todo_item"] = null;
        unset($_SESSION["todo_item"]);
    }
...
<body>
    ...
    <div class="container">
        ...
        <!-- ペジネーション -->
        <?php  include (dirname(__FILE__) . "/../common/todo/pagination/pagination.php"); ?>
    </div>
